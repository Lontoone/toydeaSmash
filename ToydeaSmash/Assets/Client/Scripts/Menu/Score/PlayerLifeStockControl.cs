...
public class PlayerLifeStockControl : MonoBehaviour
{
    ...
    public void SetUpColor(int _playerIndex)
    {
        int _teamCode = 0;
        //int _lifeStock = 0;
        ...
        Debug.Log("set life stock ui  index " + _playerIndex + " " + _c + " ");
    }

    public void SetLifeCount(int _count)
    {
        lifeStock_number_text.text = _count.ToString();
        Debug.Log("set life stock ui _count " + _count);
    }
